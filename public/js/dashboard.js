// ====== Config ======
const apiBase = "https://options-analysis.onrender.com"; // <- FIXED BASE
...
// Centered window: ATM ± window (rows = 2*window + 1)
...
btnLoadMore?.addEventListener("click", async () => {
  current.strikes_window += 5;            // +5 more each time
...
(async function init() {
  try {
    ...
    // Optional: preselect first instrument for faster start
